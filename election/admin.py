...
class CommitteeElectionAdmin(admin.ModelAdmin):
    list_display = ('id', 'building', 'phase', 'elected_member', 'position', 'creation_time', 'nomination_start_time', 'nomination_end_time', 'voting_start_time', 'voting_end_time', 'vote_count', 'no_of_candidates')
